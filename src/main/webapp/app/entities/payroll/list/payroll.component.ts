...
export class PayrollComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPayroll): number => this.payrollService.getPayrollIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.payrolls = this.refineData(dataFromBody);
  }

  protected refineData(data: IPayroll[]): IPayroll[] {
