...
import com.techfinite.lms.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).email(DEFAULT_EMAIL);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).email(UPDATED_EMAIL);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).email(UPDATED_EMAIL);
